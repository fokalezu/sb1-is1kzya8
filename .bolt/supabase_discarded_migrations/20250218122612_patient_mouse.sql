...
DROP POLICY IF EXISTS "admin_read_sms_settings_v2" ON sms_gateway_settings;
DROP POLICY IF EXISTS "admin_update_sms_settings_v2" ON sms_gateway_settings;
...
CREATE POLICY "admin_read_sms_settings_v3"
...
CREATE POLICY "admin_write_sms_settings_v3"
