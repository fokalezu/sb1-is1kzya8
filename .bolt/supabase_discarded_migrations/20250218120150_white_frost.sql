...
COMMENT ON COLUMN sms_gateway_settings.username IS 'Username for SMS gateway authentication';
COMMENT ON COLUMN sms_gateway_settings.password IS 'Password for SMS gateway authentication';